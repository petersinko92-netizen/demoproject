...
old_script = """<script type="text/javascript" dangerouslySetInnerHTML={{
          __html: `
...
new_script = """<script type="text/javascript" dangerouslySetInnerHTML={{
          __html: `
...
print("Replaced Tawk.to with Smartsupp")
